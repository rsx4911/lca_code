...
(function () {
  ...
  var CONFIG = {
    ...
    apiUrl: 'https://lca-dev.nal.usda.gov/system/menu/main/linkset', //stage/prod Drupal Homepage URL - use dev path as an example since only dev's linkset is enabled
    ...
    drupalBaseUrl: 'https://lca-dev.nal.usda.gov', //stage/prod Drupal Homepage URL - - use dev path as an example since only dev's linkset is enabled
