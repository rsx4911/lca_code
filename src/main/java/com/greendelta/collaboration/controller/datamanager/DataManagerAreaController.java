...
@RestController
@RequestMapping("ws/datamanager/area")
public class DataManagerAreaController {
	...
	public DataManagerAreaController(RepositoryService repoService, UserService service, GroupService groupService,
