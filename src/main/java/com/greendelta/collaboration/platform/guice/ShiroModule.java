...
public class ShiroModule extends ShiroWebModule {
	...
	public static final String[] CUSTOM_PUBLIC_RESOURCES = { "/header", "/imprint", "/index", "/index", "/login", "/test" };
	...
	protected void configureShiroWeb() {
		...
		anonymous("/", "/login", "/reset-password", "/sign-up", "/imprint", "/maintenance", "/job", "/search", "/search/**");
