...
public class IndexService {
	...
	private Dataset toDataset(CommitReference reference, Map<String, Object> data) {
		ObjectMap map = ObjectMap.fromMap(data);
		Dataset dataset = new Dataset();
		dataset.type = reference.type;
		dataset.refId = reference.refId;
		...
		if (reference.type == ModelType.CATEGORY) {
