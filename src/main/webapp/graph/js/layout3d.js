...
window.Layout3d = {};
window.Layout3d.createGraph = function () {
	return require('ngraph.graph')();
};
window.Layout3d.createLayout = function (diagram, iterations) {
	if (!iterations) {
		iterations = 25;
	}
	var layout = require('ngraph.forcelayout3d')(diagram.graph);
	return {
		isRunning: false,
		diagram: diagram,
		layout: layout,
		start: function () {
			this.isRunning = true;
			var _this = this;
			this.diagram.graph.forEachNode(function (n) {
				if (!n.isNew) {
					return;
				}
				n.isNew = false;
				var node = _this.getNode(n);
				if (!node || !n.parentId) {
					return;
				}
				var pos = _this.layout.getNodePosition(n.parentId);
				_this.layout.setNodePosition(n.id, pos.x, pos.y, pos.z);			
			});			
			...
			this.diagram.graph.forEachNode(function (n) {
				...
				var pos = _this.layout.getNodePosition(n.id);
				_this.diagram.positionNode(node, pos.x / 10, pos.y / 10, pos.z / 10);			
			});
			this.isRunning = false;
			if (!diagram.isComplete) {
				setTimeout(function () {_this.start();}, 10);				
			} else {
				requestAnimationFrame(function () {_this.diagram.render();});
			}
		},
		getNode: function (n) {
			if (!n.id) {
			...
			return this.diagram.nodes[n.id];
		}
	}
};

},{"ngraph.forcelayout3d":2,"ngraph.graph":29}],2:[function(require,module,exports){
/**
...
},{"./lib/bounds":3,"./lib/createBody":4,"./lib/dragForce":5,"./lib/eulerIntegrator":6,"./lib/springForce":7,"ngraph.forcelayout":9,"ngraph.merge":22,"ngraph.quadtreebh3d":24}],3:[function(require,module,exports){
...
},{"ngraph.physics.primitives":23}],5:[function(require,module,exports){
/**
...
},{"ngraph.expose":8,"ngraph.merge":22}],6:[function(require,module,exports){
/**
...
},{"ngraph.expose":8,"ngraph.merge":22,"ngraph.random":28}],8:[function(require,module,exports){
...
},{"ngraph.events":10,"ngraph.physics.simulator":11}],10:[function(require,module,exports){
...
},{"./lib/bounds":12,"./lib/createBody":13,"./lib/dragForce":14,"./lib/eulerIntegrator":15,"./lib/spring":16,"./lib/springForce":17,"ngraph.events":10,"ngraph.expose":8,"ngraph.merge":22,"ngraph.quadtreebh":18}],12:[function(require,module,exports){
module.exports = function (bodies, settings) {
  var random = require('ngraph.random').random(42);
...
},{"ngraph.expose":8,"ngraph.merge":22}],15:[function(require,module,exports){
/**
...
},{"ngraph.expose":8,"ngraph.merge":22,"ngraph.random":28}],18:[function(require,module,exports){
/**
