...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, canCreateRepositories) {
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\" id=\"repositories\"\u003E\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"canCreateRepositories" in locals_for_with?locals_for_with.canCreateRepositories:typeof canCreateRepositories!=="undefined"?canCreateRepositories:undefined));;return pug_html;} return template; });