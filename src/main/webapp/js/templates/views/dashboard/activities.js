...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, repository) {
...
pug_html = pug_html + "\u003Cdiv class=\"header-box\"\u003ELatest activities";
if (repository) {
if (repository.settings.label) {
pug_html = pug_html + (" on " + (pug_escape(null == (pug_interp = repository.settings.label) ? "" : pug_interp)));
}
else {
pug_html = pug_html + (" on " + (pug_escape(null == (pug_interp = repository.group) ? "" : pug_interp)) + "\u002F" + (pug_escape(null == (pug_interp = repository.name) ? "" : pug_interp)));
}
}
pug_html = pug_html + "\u003Cform class=\"pull-right\" id=\"activities-config\"\u003E";
pug_mixins["checkbox"]('showCommitActivities', 'Commits', 'success', true);
pug_mixins["checkbox"]('showCommentActivities', 'Comments', 'success', true);
pug_mixins["checkbox"]('showTaskActivities', 'Tasks', 'success', true);
pug_html = pug_html + "\u003C\u002Fform\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\"\u003E\u003Cdiv class=\"list-container\" id=\"activity-feed\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"repository" in locals_for_with?locals_for_with.repository:typeof repository!=="undefined"?repository:undefined));;return pug_html;} return template; });