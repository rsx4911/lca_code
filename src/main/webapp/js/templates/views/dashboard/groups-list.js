...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, data, resultInfo, values) {pug_mixins["count-info"] = pug_interp = function(amount, label, labelPlural, last){
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index3 = 0, $$l = $$obj.length; pug_index3 < $$l; pug_index3++) {
        var group = $$obj[pug_index3];
pug_html = pug_html + "\u003Cdiv class=\"list-entry\"\u003E\u003Cdiv class=\"pull-left\"\u003E";
var imgSrc = group.isUserspace ? 'ws/user/avatar/' + group.name : 'ws/group/avatar/' + group.name
pug_html = pug_html + "\u003Cimg" + (" class=\"avatar\""+pug_attr("src", imgSrc, true, false)+pug_attr("aria-label", 'Avator of group ' + group.name, true, false)) + "\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"pull-left\"\u003E\u003Ca" + (" class=\"follow\""+pug_attr("href", 'groups/' + group.name, true, false)) + "\u003E\u003Cstrong\u003E" + (pug_escape(null == (pug_interp = group.label) ? "" : pug_interp)) + "\u003C\u002Fstrong\u003E\u003C\u002Fa\u003E\u003Cdiv\u003E\u003Ci\u003E";
pug_mixins["count-info"](group.repositories, 'repository', 'repositories', group.isUserspace);
if (!group.isUserspace) {
pug_mixins["count-info"](group.members, 'member', 'members', true);
}
pug_html = pug_html + "\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"description\"\u003E\u003Ci\u003E" + (pug_escape(null == (pug_interp = group.settings.description) ? "" : pug_interp)) + "\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
if (group.role) {
pug_html = pug_html + "\u003Cspan" + (" class=\"pull-right role badge\""+pug_attr("title", group.role.description, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = group.role.name) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"resultInfo" in locals_for_with?locals_for_with.resultInfo:typeof resultInfo!=="undefined"?resultInfo:undefined,"values" in locals_for_with?locals_for_with.values:typeof values!=="undefined"?values:undefined));;return pug_html;} return template; });