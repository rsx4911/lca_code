...
pug_html = pug_html + "\u003Cdiv class=\"team-member\"\u003E";
pug_mixins["user-info"](user.username, user.name);
pug_html = pug_html + "\u003Cbutton" + (" class=\"btn btn-xs btn-danger pull-right\""+" data-action=\"remove-member\""+pug_attr("data-username", user.username, true, false)+pug_attr("aria-label", 'Remove member ' + user.name, true, false)) + "\u003E\u003Cspan class=\"glyphicon glyphicon-minus\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
