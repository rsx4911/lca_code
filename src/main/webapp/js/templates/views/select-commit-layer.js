...
if (commits && commits.length && commits[0].version) {
pug_mixins["release-selection"]('commitId', 'Compare with version', commits);
}
else {
pug_mixins["commit-selection"]('commitId', 'Compare with version', commits);
}
