...
pug_html = pug_html + "\u003Cdiv class=\"header-box\"\u003EActivity feed settings\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\"\u003E\u003Cform id=\"settings-form\"\u003E";
pug_mixins["checkbox"]('showCommitActivities', 'Show commits in the activity feed');
pug_mixins["checkbox"]('showCommentActivities', 'Show comments in the activity feed');
pug_mixins["checkbox"]('showTaskActivities', 'Show tasks in the activity feed');
pug_html = pug_html + "\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined));;return pug_html;} return template; });