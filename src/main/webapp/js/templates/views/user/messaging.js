...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, blockedUsers) {
...
pug_html = pug_html + "\u003Cdiv class=\"header-box\"\u003ESettings\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\"\u003E\u003Cform id=\"settings-form\"\u003E";
pug_mixins["checkbox"]('messagingEnabled', 'Enable other users to initiate conversations with me');
pug_mixins["checkbox"]('messagingRestricted', 'Only allow team members to initiate conversations with me');
pug_html = pug_html + "\u003Chr\u002F\u003E";
pug_mixins["checkbox"]('showOnlineStatus', 'Show my online status to other users');
pug_mixins["checkbox"]('showReadReceipt', 'Show read receipts to other users');
pug_html = pug_html + "\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"header-box\"\u003EBlocked users\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\" id=\"blocked-users\"\u003EBelow is a list of users that you blocked. Simply click on '-' next to a user to unblock her or him.\u003Chr\u002F\u003E";
if (blockedUsers && blockedUsers.length) {
// iterate blockedUsers
;(function(){
  var $$obj = blockedUsers;
  if ('number' == typeof $$obj.length) {
      for (var pug_index2 = 0, $$l = $$obj.length; pug_index2 < $$l; pug_index2++) {
        var user = $$obj[pug_index2];
pug_html = pug_html + "\u003Cp\u003E \u003Cbutton" + (" class=\"btn btn-xs btn-danger unblock\""+" title=\"Unblock\""+pug_attr("data-username", user.username, true, false)) + "\u003E\u003Cspan class=\"glyphicon glyphicon-minus\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E " + (pug_escape(null == (pug_interp = user.name) ? "" : pug_interp)) + "\t\u003C\u002Fp\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003Cspan\u003E\u003Ci\u003ECurrently you haven't blocked any users\u003C\u002Fi\u003E\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"blockedUsers" in locals_for_with?locals_for_with.blockedUsers:typeof blockedUsers!=="undefined"?blockedUsers:undefined));;return pug_html;} return template; });