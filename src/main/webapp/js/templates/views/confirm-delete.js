...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, confirmationPhrase, text) {
...
pug_html = pug_html + "\u003Ch4\u003E" + (pug_escape(null == (pug_interp = text) ? "" : pug_interp)) + "\u003C\u002Fh4\u003E\u003Cp\u003EPlease enter \u003Cspan class=\"confirmation-phrase\"\u003E" + (pug_escape(null == (pug_interp = confirmationPhrase) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E to proceed\u003C\u002Fp\u003E";
pug_mixins["input"].call({
attributes: {"aria-label": "Confirmation phrase"}
}, 'confirmation-phrase');}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"confirmationPhrase" in locals_for_with?locals_for_with.confirmationPhrase:typeof confirmationPhrase!=="undefined"?confirmationPhrase:undefined,"text" in locals_for_with?locals_for_with.text:typeof text!=="undefined"?text:undefined));;return pug_html;} return template; });