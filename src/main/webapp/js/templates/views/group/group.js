...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, group, inline, window) {pug_mixins["static"] = pug_interp = function(id, label, value, href){
...
pug_mixins["input"].call({
attributes: {"value": pug_escape(group.settings.label)}
}, 'label', 'Label');
...
pug_html = pug_html + "\u003Cdiv class=\"list-container\" id=\"group-repositories\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"group" in locals_for_with?locals_for_with.group:typeof group!=="undefined"?group:undefined,"inline" in locals_for_with?locals_for_with.inline:typeof inline!=="undefined"?inline:undefined,"window" in locals_for_with?locals_for_with.window:typeof window!=="undefined"?window:undefined));;return pug_html;} return template; });