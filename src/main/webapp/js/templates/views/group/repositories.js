...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, data, resultInfo, values) {
...
if (repo.role) {
pug_html = pug_html + "\u003Cspan" + (" class=\"pull-right role badge badge-warning\""+pug_attr("title", repo.role.description, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = repo.role.name) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003Cdiv\u003E\u003Ci\u003E";
pug_mixins["count-info"](repo.commits, 'commit', 'commits', false);
pug_mixins["count-info"](repo.datasets, 'data set', 'data sets', false);
...
pug_html = pug_html + "\u003Cspan class=\"badge badge-success public-access-badge\"\u003EPublic\u003C\u002Fspan\u003E";
}
...
pug_html = pug_html + "\u003Cdiv class=\"list-entry small-padding repository-entry\"\u003E";
pug_mixins["repository-entry"](repo, true);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
