...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, commitId, label, releases, selectVersion) {
...
pug_html = pug_html + "\u003Cform id=\"model-selection\"\u003E\u003Clabel\u003E" + (pug_escape(null == (pug_interp = label) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E\u003Cdiv id=\"model-tree\"\u003E\u003C\u002Fdiv\u003E";
if (selectVersion) {
pug_html = pug_html + "\u003Cbr\u002F\u003E";
if (releases) {
pug_mixins["release-selection"]('commitId', 'Version', releases);
}
else {
pug_mixins["select"]('commitId', 'Version');
}
}
pug_html = pug_html + "\u003C\u002Fform\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"commitId" in locals_for_with?locals_for_with.commitId:typeof commitId!=="undefined"?commitId:undefined,"label" in locals_for_with?locals_for_with.label:typeof label!=="undefined"?label:undefined,"releases" in locals_for_with?locals_for_with.releases:typeof releases!=="undefined"?releases:undefined,"selectVersion" in locals_for_with?locals_for_with.selectVersion:typeof selectVersion!=="undefined"?selectVersion:undefined));;return pug_html;} return template; });