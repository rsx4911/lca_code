...
pug_html = pug_html + "\u003Cli class=\"divider\" role=\"separator\"\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca href=\"#\" data-format=\"json\" data-action=\"select-data\"\u003Eas JSON-LD (Subselect)...\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca href=\"#\" data-format=\"ilcd\" data-action=\"select-data\"\u003Eas ILCD (Subselect)...\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003C\u002Fdiv\u003E";
};
...
pug_mixins["category-or-description"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (!pathAsArray.length && settings.description) {
pug_html = pug_html + "\u003Cdiv class=\"repository-description\"\u003E \u003Cp\u003E" + (pug_escape(null == (pug_interp = settings.description) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
...
pug_mixins["category-breadcrumb"](pathAsArray, baseUrl, false, false, commitId);
}
};
...
pug_html = pug_html + "\u003Coption" + (pug_attr("class", pug_classes([commit.modelHasChanged?'highlight':null], [true]), false, false)+pug_attr("value", commit.id, true, false)+pug_attr("selected", (!commitId&&index===0)||commit.id===commitId, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = index===0?'Latest':commit.id) ? "" : pug_interp)) + "\u003C\u002Foption\u003E\u003Coptgroup" + (" class=\"additional-info\""+pug_attr("label", '&nbsp; &nbsp;' + commit.message, false, false)) + "\u003E\u003C\u002Foptgroup\u003E";
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
}, 'commit', 'Commit', null, null, true);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"pull-right\"\u003E";
pug_mixins["download-dropdown"]();
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E";
if (categoryPath) {
pug_html = pug_html + "\u003Cdiv class=\"form-group\"\u003E\u003Cinput class=\"form-control input-lg\" id=\"filter\" type=\"text\" placeholder=\"Filter by name\" aria-label=\"Filter by name\"\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
if (!isPublic || pathAsArray) {
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["header-box",!showCommitSelection&&!categoryPath?'only-box':null], [false,true]), false, false)) + "\u003E";
if (!showCommitSelection) {
pug_html = pug_html + "\u003Cdiv class=\"pull-left\"\u003E";
pug_mixins["category-or-description"]();
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"pull-right\"\u003E";
pug_mixins["download-dropdown"]();
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
...
pug_html = pug_html + "\u003Ctbody\u003E\u003C\u002Ftbody\u003E\u003C\u002Ftable\u003E\u003Cdiv class=\"no-content-message\" style=\"display:none\"\u003ENo data sets found\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"$" in locals_for_with?locals_for_with.$:typeof $!=="undefined"?$:undefined,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"baseUrl" in locals_for_with?locals_for_with.baseUrl:typeof baseUrl!=="undefined"?baseUrl:undefined,"categoryPath" in locals_for_with?locals_for_with.categoryPath:typeof categoryPath!=="undefined"?categoryPath:undefined,"commitId" in locals_for_with?locals_for_with.commitId:typeof commitId!=="undefined"?commitId:undefined,"commits" in locals_for_with?locals_for_with.commits:typeof commits!=="undefined"?commits:undefined,"formatDate" in locals_for_with?locals_for_with.formatDate:typeof formatDate!=="undefined"?formatDate:undefined,"inline" in locals_for_with?locals_for_with.inline:typeof inline!=="undefined"?inline:undefined,"isPublic" in locals_for_with?locals_for_with.isPublic:typeof isPublic!=="undefined"?isPublic:undefined,"pathAsArray" in locals_for_with?locals_for_with.pathAsArray:typeof pathAsArray!=="undefined"?pathAsArray:undefined,"settings" in locals_for_with?locals_for_with.settings:typeof settings!=="undefined"?settings:undefined,"value" in locals_for_with?locals_for_with.value:typeof value!=="undefined"?value:undefined));;return pug_html;} return template; });