...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, commits, formatCommitDescription, groups) {
...
pug_html = pug_html + "\u003Cform id=\"clone-form\"\u003E\u003Cdiv class=\"alert\" id=\"clone-form-general-message-group\" role=\"alert\"\u003E\u003Cspan class=\"message\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
pug_mixins["input"]('clone-name', 'Name');
pug_mixins["select"]('clone-group', 'Group', groups);
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var i = 0, $$l = $$obj.length; i < $$l; i++) {
        var commit = $$obj[i];
pug_html = pug_html + "\u003Coption" + (pug_attr("value", commit.id, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = i===0?'Latest':commit.id) ? "" : pug_interp)) + "\u003C\u002Foption\u003E\u003Coptgroup" + (" class=\"additional-info\""+pug_attr("label", '&nbsp; &nbsp;' + formatCommitDescription(commit.message), false, false)) + "\u003E\u003C\u002Foptgroup\u003E";
      }
  } else {
    var $$l = 0;
    for (var i in $$obj) {
...
}, 'clone-commit', 'Version');
pug_html = pug_html + "\u003C\u002Fform\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"commits" in locals_for_with?locals_for_with.commits:typeof commits!=="undefined"?commits:undefined,"formatCommitDescription" in locals_for_with?locals_for_with.formatCommitDescription:typeof formatCommitDescription!=="undefined"?formatCommitDescription:undefined,"groups" in locals_for_with?locals_for_with.groups:typeof groups!=="undefined"?groups:undefined));;return pug_html;} return template; });