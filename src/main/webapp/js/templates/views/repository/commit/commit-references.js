...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index3 = 0, $$l = $$obj.length; pug_index3 < $$l; pug_index3++) {
        var dataset = $$obj[pug_index3];
if (dataset.type !== 'IMPACT_CATEGORY' && dataset.type !== 'NW_SET') {
pug_html = pug_html + "\u003Cdiv" + (" class=\"file-reference\""+pug_attr("id", dataset.id, true, false)) + "\u003E";
var url = baseUrl + '/' + dataset.type + '/' + dataset.refId + '?commitId=' + commitId;				
pug_html = pug_html + "\u003Cdiv class=\"header\"\u003E\u003Ca" + (pug_attr("class", pug_classes([standalone?'standalone':null], [true]), false, false)+pug_attr("data-type", dataset.added?'added':dataset.deleted?'deleted':'changed', true, false)+pug_attr("href", standalone?commitId+'-'+dataset.refId+'.html':url, true, false)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/overlay/' + action + '/' + processType + '.png', true, false)+pug_attr("aria-label", 'Model icon of ' + dataset.processType + ' ' + action, true, false)) + "\u002F\u003E";
}
else
if (dataset.type === 'FLOW' && dataset.flowType) {
var flowType = dataset.flowType === 'PRODUCT_FLOW' ? 'flow_product' : dataset.flowType === 'WASTE_FLOW' ? 'flow_waste' : 'flow_elementary';
pug_html = pug_html + "\u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/overlay/' + action + '/' + flowType + '.png', true, false)+pug_attr("aria-label", 'Model icon of ' + dataset.flowType + ' ' + action, true, false)) + "\u002F\u003E";
}
else {
pug_html = pug_html + "\u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/overlay/' + action + '/' + dataset.type.toLowerCase() + '.png', true, false)+pug_attr("aria-label", 'Model icon of ' + dataset.type + ' ' + action, true, false)) + "\u002F\u003E";
}
}
else {
pug_html = pug_html + "\u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/' + dataset.type.toLowerCase() + '.png', true, false)+pug_attr("aria-label", 'Model icon of ' + dataset.type, true, false)) + "\u002F\u003E";
}
