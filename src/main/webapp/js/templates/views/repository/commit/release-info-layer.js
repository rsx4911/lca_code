...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, dataTypes, values) {
...
pug_html = pug_html + "\u003Cform id=\"release-info\"\u003E\u003Cdiv class=\"three-columns\"\u003E";
pug_mixins["input"].call({
attributes: {"value": pug_escape(values.label)}
}, 'label', 'Label*');
pug_mixins["input"].call({
attributes: {"value": pug_escape(values.version)}
}, 'version', 'Version*');
pug_mixins["select"]('typeOfData', 'Type of data', dataTypes, values.typeOfData);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
pug_mixins["input"].call({
attributes: {"value": pug_escape(values.tags?values.tags.join(','):'')}
}, 'tags', 'Tags (comma separated list)');
pug_html = pug_html + "\u003Cdiv class=\"two-columns\"\u003E";
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.description) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'description', 'Description');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.sourceInfo) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'sourceInfo', 'Source information');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.contactInfo) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'contactInfo', 'Contact information');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.changeLog) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'changeLog', 'Change log');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.projectInfo) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'projectInfo', 'Project information');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.projectFunding) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'projectFunding', 'Project funding');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.appropriateUse) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'appropriateUse', 'Appropriate use');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.dqAssessment) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'dqAssessment', 'Data quality assessment');
pug_mixins["textarea"].call({
block: function(){
pug_html = pug_html + (pug_escape(null == (pug_interp = values.citation) ? "" : pug_interp));
},
attributes: {"rows": 5}
}, 'citation', 'Citation');
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"dataTypes" in locals_for_with?locals_for_with.dataTypes:typeof dataTypes!=="undefined"?dataTypes:undefined,"values" in locals_for_with?locals_for_with.values:typeof values!=="undefined"?values:undefined));;return pug_html;} return template; });