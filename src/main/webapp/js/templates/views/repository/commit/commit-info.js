...
var pug_match_html=/["&<>]/;function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (additions, deletions, updates) {pug_mixins["commit-info-entry"] = pug_interp = function(value, label, clazz, first){
...
pug_mixins["commit-info"](additions, updates, deletions);}.call(this,"additions" in locals_for_with?locals_for_with.additions:typeof additions!=="undefined"?additions:undefined,"deletions" in locals_for_with?locals_for_with.deletions:typeof deletions!=="undefined"?deletions:undefined,"updates" in locals_for_with?locals_for_with.updates:typeof updates!=="undefined"?updates:undefined));;return pug_html;} return template; });