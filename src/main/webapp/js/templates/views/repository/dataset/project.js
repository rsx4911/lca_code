...
pug_mixins["field-block"] = pug_interp = function(path, defaultLabel){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_mixins["sub-field-block"].call({
attributes: attributes
}, dataset, compareTo, path, null, defaultLabel);
};
...
pug_mixins["project-variant-table"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"table\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('variants.name')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('variants.productSystem')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('variants.allocationMethod')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('variants.amount')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('variants.description')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('variants.isDisabled')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Fthead\u003E\u003Ctbody\u003E";
// iterate getArrayValues(dataset, compareTo, 'VARIANT', 'variants')
;(function(){
  var $$obj = getArrayValues(dataset, compareTo, 'VARIANT', 'variants');
  if ('number' == typeof $$obj.length) {
      for (var pug_index12 = 0, $$l = $$obj.length; pug_index12 < $$l; pug_index12++) {
        var values = $$obj[pug_index12];
pug_mixins["project-variant-row"](values[0], values[1]);
      }
  } else {
    var $$l = 0;
...
pug_mixins["project-variant-row"] = pug_interp = function(variant, other){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_mixins["compare-icon"](changed);
pug_mixins["sub-field"](variant, other, 'name');
pug_html = pug_html + "\u003C\u002Ftd\u003E";
var system = getValue(variant, 'productSystem');
var otherSystem = getValue(other, 'productSystem');
pug_html = pug_html + "\u003Ctd\u003E";
pug_mixins["ref"](system, otherSystem);
pug_html = pug_html + "\u003C\u002Ftd\u003E";
pug_mixins["sub-field-cell"](variant, other, 'allocationMethod');
pug_html = pug_html + "\u003Ctd\u003E ";
pug_mixins["sub-field"](variant, other, 'amount');
pug_html = pug_html + "&nbsp;";
pug_mixins["sub-field"](variant, other, 'unit.name');
pug_html = pug_html + "\u003C\u002Ftd\u003E";
pug_mixins["sub-field-cell"](variant, other, 'description');
pug_html = pug_html + "\u003Ctd\u003E ";
pug_mixins["boolean-sub-field"](variant, other, 'isDisabled');
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003Ctd" + (pug_attr("data-path", variant&&system?'variants[' + system.id + '-' + variant.name + ']':null, true, false)) + "\u003E\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";
};
...
pug_mixins["project-parameter-redef-table"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"table\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('parameters.context')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('parameters.name')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
// iterate dataset.variants
;(function(){
  var $$obj = dataset.variants;
  if ('number' == typeof $$obj.length) {
      for (var pug_index25 = 0, $$l = $$obj.length; pug_index25 < $$l; pug_index25++) {
        var variant = $$obj[pug_index25];
pug_html = pug_html + "\u003Cth\u003E" + (pug_escape(null == (pug_interp = variant.name) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('parameters.isProtected')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Fthead\u003E\u003Ctbody\u003E";
...
pug_mixins["project-parameter-redef-row"](values[0], values[1]);
      }
  } else {
    var $$l = 0;
...
pug_mixins["project-parameter-redef-row"] = pug_interp = function(parameter, other){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_html = pug_html + "\u003C\u002Ftd\u003E";
pug_mixins["sub-field-cell"](parameter, other, 'name');
if (parameter && parameter.values) {
// iterate parameter.values
;(function(){
  var $$obj = parameter.values;
  if ('number' == typeof $$obj.length) {
      for (var index = 0, $$l = $$obj.length; index < $$l; index++) {
        var entry = $$obj[index];
...
attributes: {"data-path": pug_escape(entry.commentPath)}
}, entry, otherEntry, 'value');
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
pug_html = pug_html + "\u003Ctd\u003E";
pug_mixins["boolean-sub-field"](paramter, other, 'isProtected');
pug_html = pug_html + "\u003C\u002Ftd\u003E";
if (!parameter && other && other.values) {
// iterate other.values
;(function(){
  var $$obj = other.values;
  if ('number' == typeof $$obj.length) {
      for (var index = 0, $$l = $$obj.length; index < $$l; index++) {
        var entry = $$obj[index];
pug_html = pug_html + "\u003Ctd class=\"comparison-value\"\u003E" + (pug_escape(null == (pug_interp = entry.value) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
pug_mixins["nav-tab"]('variants', true);
pug_mixins["nav-tab"]('parameterRedefs');
pug_html = pug_html + "\u003C\u002Ful\u003E\u003Cdiv class=\"tab-content\"\u003E";
pug_mixins["nav-tab-pane"].call({
block: function(){
pug_mixins["project-variant-table"]();
}
}, 'variants', true);
pug_mixins["nav-tab-pane"].call({
block: function(){
pug_mixins["project-parameter-redef-table"]();
}
}, 'parameterRedefs', true);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
});
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
