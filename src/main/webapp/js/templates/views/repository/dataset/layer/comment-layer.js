...
pug_html = pug_html + ("\u003Cdiv class=\"dataset-link\"\u003E\u003Ca" + (" class=\"default-link\""+pug_attr("href", comment.repositoryPath + '/dataset/' + field.modelType + '/' + field.refId + query, true, false)) + "\u003E \u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/' + field.modelType.toLowerCase() + '.png', true, false)+pug_attr("aria-label", 'Icon of ' + field.modelType, true, false)) + "\u002F\u003E\u003Cspan\u003E" + (pug_escape(null == (pug_interp = comment.dsPath) ? "" : pug_interp)));
if (label) {
...
if (canComment) {
pug_html = pug_html + "\u003Cdiv class=\"new-comment-wrapper\"\u003E\u003Cdiv class=\"form-group\" id=\"new-comment-group\"\u003E\u003Clabel class=\"control-label\" for=\"new-comment\"\u003ENew comment ";
pug_mixins["comment-visibility"](newCommentRestrictedToRole, roles);
pug_html = pug_html + "\u003C\u002Flabel\u003E\u003Ctextarea class=\"form-control\" id=\"new-comment\" name=\"new-comment\" rows=\"5\"\u003E\u003C\u002Ftextarea\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
if (comments && comments.length && canComment) {
pug_html = pug_html + "\u003Chr\u002F\u003E";
}
pug_html = pug_html + "\u003Cdiv class=\"comments\"\u003E";
// iterate comments
;(function(){
  var $$obj = comments;
  if ('number' == typeof $$obj.length) {
...
pug_mixins["comment-entry"](comment, roles);
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E";}.call(this,"canApprove" in locals_for_with?locals_for_with.canApprove:typeof canApprove!=="undefined"?canApprove:undefined,"canComment" in locals_for_with?locals_for_with.canComment:typeof canComment!=="undefined"?canComment:undefined,"canEdit" in locals_for_with?locals_for_with.canEdit:typeof canEdit!=="undefined"?canEdit:undefined,"comments" in locals_for_with?locals_for_with.comments:typeof comments!=="undefined"?comments:undefined,"currentUser" in locals_for_with?locals_for_with.currentUser:typeof currentUser!=="undefined"?currentUser:undefined,"formatDate" in locals_for_with?locals_for_with.formatDate:typeof formatDate!=="undefined"?formatDate:undefined,"getLabel" in locals_for_with?locals_for_with.getLabel:typeof getLabel!=="undefined"?getLabel:undefined,"getRoleLabel" in locals_for_with?locals_for_with.getRoleLabel:typeof getRoleLabel!=="undefined"?getRoleLabel:undefined,"newCommentRestrictedToRole" in locals_for_with?locals_for_with.newCommentRestrictedToRole:typeof newCommentRestrictedToRole!=="undefined"?newCommentRestrictedToRole:undefined,"roles" in locals_for_with?locals_for_with.roles:typeof roles!=="undefined"?roles:undefined));;return pug_html;} return template; });