...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, baseUrl, commitId, data, getIcon, pageSizeId, resultInfo, values) {
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index2 = 0, $$l = $$obj.length; pug_index2 < $$l; pug_index2++) {
        var element = $$obj[pug_index2];
pug_html = pug_html + "\u003Cdiv\u003E \u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/' + getIcon(element), true, false)+pug_attr("aria-label", 'Model icon of ' + element.type, true, false)) + "\u002F\u003E";
var query = commitId ? '?commitId=' + commitId : ''
pug_html = pug_html + "\u003Ca" + (pug_attr("href", baseUrl + '/' + element.type + '/' + element.refId + query, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = element.name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
