...
pug_mixins["ref-field"] = pug_interp = function(path, defaultLabel){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var value = getValue(dataset, path);
var value2 = getValue(compareTo, path); 
var changed = compareTo ? compare(value, value2) : null;
pug_html = pug_html + "\u003Cspan" + (pug_attr("data-compare", changed, true, false)+pug_attr("data-path", path, true, false)) + "\u003E";
pug_mixins["compare-icon"](changed);
...
pug_mixins["epd-modules-table"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"table epd-modules\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('modules.name')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('modules.multiplier')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('modules.result')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Fthead\u003E\u003Ctbody\u003E";
// iterate getArrayValues(dataset, compareTo, 'EPD_MODULE', 'modules')
;(function(){
  var $$obj = getArrayValues(dataset, compareTo, 'EPD_MODULE', 'modules');
  if ('number' == typeof $$obj.length) {
      for (var pug_index12 = 0, $$l = $$obj.length; pug_index12 < $$l; pug_index12++) {
        var values = $$obj[pug_index12];
pug_mixins["epd-module-row"](values[0], values[1]);
      }
  } else {
    var $$l = 0;
...
pug_mixins["epd-module-row"] = pug_interp = function(epdModule, otherEpdModule){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_mixins["sub-field-cell"](epdModule, otherEpdModule, 'name');
pug_mixins["sub-field-cell"](epdModule, otherEpdModule, 'multiplier');
pug_mixins["sub-field-ref-cell"](epdModule, otherEpdModule, 'result');
pug_html = pug_html + "\u003Ctd" + (pug_attr("data-path", epdModule?'modules[' + epdModule.name +']':null, true, false)) + "\u003E\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";
};
pug_mixins["menubar"]();
...
block: function(){
pug_html = pug_html + "\u003Cdiv class=\"margin-0-25\"\u003E";
pug_mixins["epd-modules-table"]();
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
});
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
