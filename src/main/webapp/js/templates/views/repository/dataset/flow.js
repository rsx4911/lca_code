...
pug_mixins["flow-property-row"](values[0], values[1], refFactor);
      }
  } else {
    var $$l = 0;
...
pug_mixins["flow-property-row"] = pug_interp = function(factor, other, refFactor){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_html = pug_html + "\u003Ctr" + (pug_attr("class", pug_classes([getValue(factor, 'isRefFlowProperty')?'reference':null], [true]), false, false)+pug_attr("data-compare", changed, true, false)) + "\u003E\u003Ctd\u003E";
pug_mixins["compare-icon"](changed);
pug_mixins["ref"](property, otherProperty);
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003Ctd\u003E1 " + (pug_escape(null == (pug_interp = refFactor.flowProperty.refUnit) ? "" : pug_interp)) + " = ";
pug_mixins["sub-field"](factor, other, 'conversionFactor');
pug_html = pug_html + " ";
pug_mixins["sub-field"](property, otherProperty, 'refUnit');
...
block: function(){
var outId = dataset.flowType==='ELEMENTARY_FLOW'?'emittedBy':'producedBy';
pug_html = pug_html + "\u003Cul class=\"nav nav-tabs\" role=\"tablist\"\u003E";
pug_mixins["nav-tab"]('flowInfo', true, true);
pug_mixins["nav-tab"]('flowProperties');
if (isSearchLinksEnabled) {
pug_mixins["nav-tab"]('usedBy', false, true);
pug_mixins["nav-tab"](outId, false, true);
}
...
pug_mixins["boolean-field-row"]('isInfrastructureFlow');
pug_html = pug_html + "\u003C\u002Ftbody\u003E\u003C\u002Ftable\u003E";
}
}, 'flowInfo', true, true);
pug_mixins["nav-tab-pane"].call({
...
pug_mixins["nav-tab-pane"].call({
block: function(){
pug_html = pug_html + "\u003Cdiv class=\"form-group\"\u003E\u003Cinput class=\"form-control\" id=\"usedBy-filter\" type=\"text\" placeholder=\"Filter by name\" aria-label=\"Filter by name\"\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv id=\"usedBy-data\"\u003E\u003C\u002Fdiv\u003E";
}
}, 'usedBy', false, true);
pug_mixins["nav-tab-pane"].call({
block: function(){
