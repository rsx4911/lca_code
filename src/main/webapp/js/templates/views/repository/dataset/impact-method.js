...
pug_mixins["impact-category-table"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"table impact-categories\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('impactCategories.name')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('impactCategories.refUnit')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Fthead\u003E\u003Ctbody\u003E";
// iterate getArrayValues(dataset, compareTo, 'IMPACT_CATEGORY', 'impactCategories')
;(function(){
  var $$obj = getArrayValues(dataset, compareTo, 'IMPACT_CATEGORY', 'impactCategories');
  if ('number' == typeof $$obj.length) {
      for (var pug_index9 = 0, $$l = $$obj.length; pug_index9 < $$l; pug_index9++) {
        var values = $$obj[pug_index9];
pug_mixins["impact-category-row"](values[0], values[1]);
      }
  } else {
    var $$l = 0;
...
pug_mixins["impact-category-row"] = pug_interp = function(category, other){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_mixins["compare-icon"](changed);
pug_mixins["ref"](category, other);
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003Ctd\u003E";
pug_mixins["sub-field"](category, other, 'refUnit');
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003Ctd" + (pug_attr("data-path", category?'impactCategories[' + category.id + ']':null, true, false)) + "\u003E\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";
};
...
pug_mixins["nw-factor-table"] = pug_interp = function(set, otherSet){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_html = pug_html + "\u003Ctable class=\"table\" id=\"nw-factors\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('nwSets.factors.impactCategory')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E";
if (showNorm) {
pug_html = pug_html + (pug_escape(null == (pug_interp = getLabel('nwSets.factors.normalisationFactor')) ? "" : pug_interp));
}
pug_html = pug_html + "\u003C\u002Fth\u003E\u003Cth\u003E";
if (showWeight) {
pug_html = pug_html + (pug_escape(null == (pug_interp = getLabel('nwSets.factors.weightingFactor')) ? "" : pug_interp));
}
...
pug_mixins["nw-factor-row"](values[0], values[1]);
      }
  } else {
    var $$l = 0;
...
pug_mixins["nw-factor-row"] = pug_interp = function(factor, otherFactor, nwSetId){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_html = pug_html + "\u003Ctr" + (pug_attr("data-compare", changed, true, false)) + "\u003E\u003Ctd\u003E";
pug_mixins["sub-field"](category, otherCategory, 'name');
pug_html = pug_html + "\u003C\u002Ftd\u003E";
pug_mixins["sub-field-cell"](factor, otherFactor, 'normalisationFactor', null, formatScientific);
pug_mixins["sub-field-cell"](factor, otherFactor, 'weightingFactor', null, formatScientific);
pug_html = pug_html + "\u003Ctd" + (pug_attr("data-path", category?'nwSets[' + nwSetId + '].factors[' + category.id +']':null, true, false)) + "\u003E\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";
};
pug_mixins["menubar"]();
...
pug_mixins["nav-tab"]('impactCategories', true);
pug_mixins["nav-tab"]('nwSets');
pug_mixins["nav-tab"]('parameters');
pug_html = pug_html + "\u003C\u002Ful\u003E\u003Cdiv class=\"tab-content\"\u003E";
pug_mixins["nav-tab-pane"].call({
block: function(){
pug_mixins["impact-category-table"]();
}
}, 'impactCategories', true);
pug_mixins["nav-tab-pane"].call({
block: function(){
// iterate getArrayValues(dataset, compareTo, 'NW_SET', 'nwSets')
;(function(){
  var $$obj = getArrayValues(dataset, compareTo, 'NW_SET', 'nwSets');
  if ('number' == typeof $$obj.length) {
      for (var pug_index32 = 0, $$l = $$obj.length; pug_index32 < $$l; pug_index32++) {
        var values = $$obj[pug_index32];
pug_html = pug_html + "\u003Ch4\u003E";
pug_mixins["sub-field"].call({
attributes: {"data-path": pug_escape(values[0]?'nwSets[' + values[0].id + ']':null)}
}, values[0], values[1], 'name');
pug_html = pug_html + " - ";
pug_mixins["sub-field"](values[0], values[1], 'weightedScoreUnit');
pug_html = pug_html + "\u003C\u002Fh4\u003E";
pug_mixins["nw-factor-table"](values[0], values[1]);
      }
  } else {
    var $$l = 0;
