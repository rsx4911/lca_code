...
pug_mixins["product-system-parameter-set-table"] = pug_interp = function(set, otherSet){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ch4\u003E";
pug_mixins["sub-field"].call({
block: function(){
pug_html = pug_html + "\u003Cbr\u002F\u003E\u003Csmall\u003E";
pug_mixins["sub-field"](set, otherSet, 'description');
pug_html = pug_html + "\u003C\u002Fsmall\u003E";
}
}, set, otherSet, 'name');
pug_html = pug_html + "\u003C\u002Fh4\u003E\u003Ctable class=\"table\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('parameterRedefs.context')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('parameterRedefs.name')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('parameterRedefs.value')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E";
...
// iterate getArrayValues(set, otherSet, 'PARAMETER_REDEF', 'parameters')
;(function(){
  var $$obj = getArrayValues(set, otherSet, 'PARAMETER_REDEF', 'parameters');
  if ('number' == typeof $$obj.length) {
...
pug_mixins["nav-tab"]('overview', true, true);
if (hasLinks && !standalone) {
pug_mixins["nav-tab"]('supplyChain', false, hasLinks);
pug_mixins["nav-tab"]('graph', false, hasLinks);
}
pug_mixins["nav-tab"]('parameterSets');
if (!standalone) {
...
pug_mixins["ref-row"]('refProcess');
if (dataset.refExchange && dataset.refExchange.flow) {
pug_mixins["ref-row"]('refExchange.flow');
}
else {
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var i = 0, $$l = $$obj.length; i < $$l; i++) {
        var values = $$obj[i];
pug_mixins["product-system-parameter-set-table"](values[0], values[1]);
if (i < sets.length - 1) {
pug_html = pug_html + "\u003Chr\u002F\u003E";
}
      }
