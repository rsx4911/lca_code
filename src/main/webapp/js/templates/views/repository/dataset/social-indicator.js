...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function ($, Math, Object, activityUnit, baseUrl, collapseLongText, commitId, commits, compare, compareTo, comparisonCommitId, dataset, findValue, formatCommitDescription, formatDate, getIcon, getLabel, getTypeAsEnum, getTypeLabel, getValue, isPublic, releases, reviewMode, standalone, value) {pug_mixins["category-breadcrumb"] = pug_interp = function(paths, baseUrl, linkLast, depth, commitId, disabled){
...
block: function(){
pug_html = pug_html + "\u003Ctable class=\"table no-head margin-0-25\"\u003E\u003Ctbody\u003E";
pug_mixins["field-row"]('unitOfMeasurement');
pug_mixins["field-row"]('evaluationScheme');
pug_mixins["field-row"]('activityVariable');
pug_mixins["ref-row"]('activityQuantity');
if (dataset.activityUnit || getValue(compareTo, activityUnit) || reviewMode) {
pug_mixins["field-row"]('activityUnit.name');
}
