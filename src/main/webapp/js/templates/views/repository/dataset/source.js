...
pug_mixins["field-link-row"] = pug_interp = function(path, urlPrefix, query){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var value = getValue(dataset, path);
var value2 = getValue(compareTo, path); 
if (value || value2 || reviewMode) {
...
pug_html = pug_html + "\u003Ca" + (" class=\"original-value\""+pug_attr("href", href, true, false)+" target=\"_blank\"") + "\u003E" + (pug_escape(null == (pug_interp = value) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
}
if (changed && value2) {
pug_html = pug_html + "\u003Cspan class=\"comparison-value\"\u003E" + (pug_escape(null == (pug_interp = value2) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
