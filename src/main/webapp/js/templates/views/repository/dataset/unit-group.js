...
pug_mixins["unit-table"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"table units\"\u003E";
...
var refUnit = null;
// iterate dataset.units
;(function(){
  var $$obj = dataset.units;
  if ('number' == typeof $$obj.length) {
      for (var pug_index12 = 0, $$l = $$obj.length; pug_index12 < $$l; pug_index12++) {
        var unit = $$obj[pug_index12];
if (unit.isRefUnit) {
refUnit = unit
}
      }
...
pug_html = pug_html + "\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('units.name')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E";
if (showDescriptions) {
pug_html = pug_html + (pug_escape(null == (pug_interp = getLabel('units.description')) ? "" : pug_interp));
}
pug_html = pug_html + "\u003C\u002Fth\u003E\u003Cth\u003E";
if (showSynonyms) {
pug_html = pug_html + (pug_escape(null == (pug_interp = getLabel('units.synonyms')) ? "" : pug_interp));
}
pug_html = pug_html + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('units.formula')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Fthead\u003E\u003Ctbody\u003E";
// iterate getArrayValues(dataset, compareTo, 'UNIT', 'units')
;(function(){
  var $$obj = getArrayValues(dataset, compareTo, 'UNIT', 'units');
  if ('number' == typeof $$obj.length) {
      for (var pug_index13 = 0, $$l = $$obj.length; pug_index13 < $$l; pug_index13++) {
        var values = $$obj[pug_index13];
pug_mixins["unit-row"](values[0], values[1], refUnit);
      }
  } else {
    var $$l = 0;
...
pug_mixins["unit-row"] = pug_interp = function(unit, other, refUnit){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var changed = compareTo && !other ? 'added' : (compareTo && !unit ? 'removed' : null);
pug_html = pug_html + "\u003Ctr" + (pug_attr("class", pug_classes([unit&&unit.isRefUnit?'reference':null], [true]), false, false)+pug_attr("data-compare", changed, true, false)) + "\u003E\u003Ctd\u003E";
pug_mixins["compare-icon"](changed);
pug_html = pug_html + (pug_escape(null == (pug_interp = unit?unit.name:other.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
pug_mixins["sub-field-cell"](unit, other, 'description');
pug_mixins["sub-field-cell"](unit, other, 'synonyms');
pug_html = pug_html + "\u003Ctd\u003E1 " + (pug_escape(null == (pug_interp = unit?unit.name:other.name) ? "" : pug_interp)) + " = ";
pug_mixins["sub-field"](unit, other, 'conversionFactor');
pug_html = pug_html + " " + (pug_escape(null == (pug_interp = refUnit.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd" + (pug_attr("data-path", unit?'units[' + unit.name + ']':null, true, false)) + "\u003E\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";
};
pug_mixins["menubar"]();
...
block: function(){
if (hasAtLeastOne(dataset, compareTo, 'units') || reviewMode) {
pug_html = pug_html + "\u003Cdiv class=\"margin-0-25\"\u003E\u003Ch4 data-path=\"units\"\u003E" + (pug_escape(null == (pug_interp = getLabel('units')) ? "" : pug_interp)) + "\u003C\u002Fh4\u003E";
pug_mixins["unit-table"]();
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
}
});
