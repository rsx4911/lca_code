...
pug_mixins["unit-row"](values[0], values[1], referenceUnit);
      }
  } else {
    var $$l = 0;
...
pug_mixins["unit-row"] = pug_interp = function(unit, other, referenceUnit){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var changed = compareTo && !other ? 'added' : (compareTo && !unit ? 'removed' : null);
pug_html = pug_html + "\u003Ctr" + (pug_attr("class", pug_classes([unit&&unit.referenceUnit?'reference':null], [true]), false, false)+pug_attr("data-compare", changed, true, false)) + "\u003E\u003Ctd\u003E";
pug_mixins["compare-icon"](changed);
