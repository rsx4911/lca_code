...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function ($, Math, Object, baseUrl, collapseLongText, commitId, commits, compare, compareTo, compareUncertainty, comparisonCommitId, dataset, factorMap, findValue, formatCommitDescription, formatDate, formatScientific, getArrayValues, getIcon, getLabel, getTypeAsEnum, getTypeLabel, getValue, hasAtLeastOne, isPublic, otherFactorMap, otherValue, releases, reviewMode, standalone, value) {pug_mixins["category-breadcrumb"] = pug_interp = function(paths, baseUrl, linkLast, depth, commitId, disabled){
...
pug_mixins["nav-tab"]('impactFactors', true);
pug_mixins["nav-tab"]('parameters');
pug_html = pug_html + "\u003C\u002Ful\u003E\u003Cdiv class=\"tab-content\"\u003E";
pug_mixins["nav-tab-pane"].call({
block: function(){
pug_html = pug_html + "\u003Ca class=\"pull-right toggle-control switch-to-list\" href=\"#\"\u003ESwitch to list view\u003C\u002Fa\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"impact-factor-table toggleable\"\u003E";
