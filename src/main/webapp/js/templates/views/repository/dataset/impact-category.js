...
pug_mixins["impact-factor-list"] = pug_interp = function(map, otherMap){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var cats1 = [];
if (map) {
// iterate Object.keys(map)
;(function(){
...
if (otherMap) {
// iterate Object.keys(otherMap)
;(function(){
  var $$obj = Object.keys(otherMap);
  if ('number' == typeof $$obj.length) {
...
var cats2 = [];
if (map && map[cat1]) {
// iterate Object.keys(map[cat1])
;(function(){
  var $$obj = Object.keys(map[cat1]);
  if ('number' == typeof $$obj.length) {
...
// iterate Object.keys(otherMap[cat1])
;(function(){
  var $$obj = Object.keys(otherMap[cat1]);
  if ('number' == typeof $$obj.length) {
...
pug_mixins["impact-factor-sublist"](rLabel, value, otherValue);
      }
  } else {
    var $$l = 0;
...
pug_mixins["impact-factor-sublist"] = pug_interp = function(title, array, otherArray){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var allValues = getArrayValues(array, otherArray, 'IMPACT_FACTOR');
if (allValues.length) {
pug_html = pug_html + "\u003Cdiv class=\"impact-factor-list-part\"\u003E\u003Ch4\u003E" + (pug_escape(null == (pug_interp = title) ? "" : pug_interp)) + "\u003C\u002Fh4\u003E\u003Ctable\u003E";
// iterate allValues
;(function(){
  var $$obj = allValues;
  if ('number' == typeof $$obj.length) {
...
pug_mixins["impact-factor"](values[0], values[1], index);
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
pug_mixins["impact-factor"] = pug_interp = function(factor, other, index){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
var changed = valueChanged || unitChanged || flowChanged;
pug_html = pug_html + "\u003Ctr" + (pug_attr("class", pug_classes([index>=10?'toggleable':null], [true]), false, false)+pug_attr("style", pug_style(index>=10?'display:none':null), true, false)) + "\u003E\u003Ctd\u003E\u003Cspan" + (" class=\"same-size-font\""+pug_attr("title", title, true, false)+pug_attr("data-compare", valueChanged, true, false)) + "\u003E";
if (factor) {
pug_html = pug_html + "\u003Cspan class=\"original-value\"\u003E";
if (factor.value > 0) {
pug_html = pug_html + "&nbsp;";
}
pug_html = pug_html + (pug_escape(null == (pug_interp = formatScientific(factor.value, true)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
...
pug_html = pug_html + (pug_escape(null == (pug_interp = formatScientific(other.value, true)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
...
pug_mixins["impact-factor-table"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_html = pug_html + "\u003Ch4" + (pug_attr("data-path", dataset?'impactCategories[' + dataset.Id + '].impactFactors':null, true, false)) + "\u003EImpact factors\u003C\u002Fh4\u003E\u003Ctable class=\"table\" id=\"impact-factors\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('impactCategories.impactFactors.flow')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('impactCategories.impactFactors.flow.category')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E" + (pug_escape(null == (pug_interp = getLabel('impactCategories.impactFactors.value')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth\u003E";
if (showUncertainties) {
pug_html = pug_html + (pug_escape(null == (pug_interp = getLabel('impactCategories.impactFactors.uncertainty')) ? "" : pug_interp));
}
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index29 = 0, $$l = $$obj.length; pug_index29 < $$l; pug_index29++) {
        var values = $$obj[pug_index29];
var categoryId = getValue(dataset, 'id');
var referenceUnit = getValue(dataset, 'referenceUnitName');
pug_mixins["impact-factor-row"](dataset, compareTo, values[0], values[1], count);
count++;
      }
  } else {
    var $$l = 0;
...
if (flowCategory) {
flowCategory.categoryType = flow.type;
}
var otherFlowCategory = getValue(otherFlow, 'category');
if (otherFlowCategory) {
otherFlowCategory.categoryType = otherFlow.type;
}
...
pug_mixins["category-field"](flowCategory, otherFlowCategory, true);
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003Ctd\u003E ";
pug_mixins["sub-field"](factor, otherFactor, 'value', null, formatScientific);
pug_html = pug_html + " ";
pug_mixins["sub-field"](category, otherCategory, 'referenceUnitName');
pug_html = pug_html + "\u002F";
