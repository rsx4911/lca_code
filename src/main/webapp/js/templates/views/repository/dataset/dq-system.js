...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function ($, Math, Object, baseUrl, clazz, collapseLongText, commitId, commits, compare, compareTo, comparisonCommitId, dataset, findValue, formatCommitDescription, formatDate, getArrayValues, getDQColor, getIcon, getLabel, getTypeAsEnum, getTypeLabel, getValue, isPublic, releases, standalone, system, value) {pug_mixins["category-breadcrumb"] = pug_interp = function(paths, baseUrl, linkLast, depth, commitId, disabled){
...
pug_mixins["sub-field-header"] = pug_interp = function(ref, ref2, path, alternativePath){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var value = getValue(ref, path, alternativePath);
var value2 = getValue(ref2, path, alternativePath); 
var changed = ref && ref2 ? compare(value, value2) : null;
pug_html = pug_html + "\u003Cth" + (pug_attrs(pug_merge([{"data-compare": pug_escape(changed)},attributes]), false)) + "\u003E";
pug_mixins["compare-icon"](changed);
pug_mixins["compare-value"](value, value2);
block && block();
...
pug_mixins["data-quality-matrix"] = pug_interp = function(system, uncertainties, entries){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (system.indicators && system.indicators.length) {
clazz = uncertainties ? 'uncertainties' : (entries ? 'center-inline' : null);
pug_html = pug_html + "\u003Ctable" + (pug_attr("class", pug_classes(["data-quality","no-head",clazz?clazz:null], [false,false,true]), false, false)) + "\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003E\u003C\u002Fth\u003E";
// iterate getArrayValues(getValue(system, 'indicators[0]'), getValue(compareTo, 'indicators[0]'), 'DQ_SCORE', 'scores')
;(function(){
  var $$obj = getArrayValues(getValue(system, 'indicators[0]'), getValue(compareTo, 'indicators[0]'), 'DQ_SCORE', 'scores');
  if ('number' == typeof $$obj.length) {
      for (var pug_index12 = 0, $$l = $$obj.length; pug_index12 < $$l; pug_index12++) {
        var values = $$obj[pug_index12];
pug_mixins["data-quality-score-header"](values[0], values[1], uncertainties);
      }
  } else {
    var $$l = 0;
...
// iterate getArrayValues(system, compareTo, 'DQ_INDICATOR', 'indicators')
;(function(){
  var $$obj = getArrayValues(system, compareTo, 'DQ_INDICATOR', 'indicators');
  if ('number' == typeof $$obj.length) {
      for (var pug_index13 = 0, $$l = $$obj.length; pug_index13 < $$l; pug_index13++) {
        var values = $$obj[pug_index13];
pug_mixins["data-quality-indicator-row"](values[0], values[1], uncertainties, entries);
      }
  } else {
    var $$l = 0;
...
pug_mixins["data-quality-indicator-row"] = pug_interp = function(indicator, otherIndicator, uncertainties, entries){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var changed = compareTo && !otherIndicator ? 'added' : (compareTo && !indicator ? 'removed' : null);
pug_html = pug_html + "\u003Ctr" + (pug_attr("data-compare", changed, true, false)) + "\u003E\u003Ctd" + (pug_attr("data-path", uncertainties||!indicator?null:'indicators[' + indicator.position + ']', true, false)) + "\u003E";
pug_mixins["compare-icon"](changed);
pug_mixins["sub-field"](indicator, otherIndicator, 'name', 'position');
pug_html = pug_html + "\u003C\u002Ftd\u003E";
// iterate getArrayValues(indicator, otherIndicator, 'DQ_SCORE', 'scores')
;(function(){
  var $$obj = getArrayValues(indicator, otherIndicator, 'DQ_SCORE', 'scores');
  if ('number' == typeof $$obj.length) {
      for (var pug_index14 = 0, $$l = $$obj.length; pug_index14 < $$l; pug_index14++) {
        var values = $$obj[pug_index14];
pug_mixins["data-quality-score-cell"](indicator, otherIndicator, values[0], values[1], uncertainties, entries);
      }
  } else {
    var $$l = 0;
...
pug_mixins["data-quality-score-cell"] = pug_interp = function(indicator, otherIndicator, score, otherScore, uncertainties, entries){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
attributes: {"data-path": pug_escape(indicator&&score?'indicators[' + indicatorPos + '].scores[' + scorePos + '].uncertainty':null),"data-indicator": pug_escape(indicatorPos),"data-score": pug_escape(scorePos),"data-table-type": "uncertainty"}
}, score, otherScore, 'uncertainty');
}
else {
var color = getDQColor(system, indicator?indicator:otherIndicator, score?score:otherScore, entries);
pug_mixins["sub-field-cell"].call({
block: function(){
pug_html = pug_html + "\u003Cspan" + (pug_attr("data-path", indicator&&score?'indicators[' + indicatorPos + '].scores[' + scorePos + '].description':null, true, false)) + "\u003E\u003C\u002Fspan\u003E";
},
attributes: {"style": pug_escape(pug_style('background-color:' + color)),"data-indicator": pug_escape(indicatorPos),"data-score": pug_escape(scorePos),"data-table-type": "description"}
}, score, otherScore, 'description');
}
};
pug_mixins["data-quality-score-header"] = pug_interp = function(score, otherScore, uncertainties){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var path = null;
if (!uncertainties && score) {
path = 'scores[' + score.position + ']';
}
pug_mixins["sub-field-header"].call({
attributes: {"data-path": pug_escape(path)}
}, score, otherScore, 'label', 'position');
};
pug_mixins["menubar"]();
...
block: function(){
pug_html = pug_html + "\u003Cdiv class=\"margin-0-25\"\u003E\u003Ch4 data-path=\"indicators\"\u003E" + (pug_escape(null == (pug_interp = getLabel('indicators')) ? "" : pug_interp)) + "\u003C\u002Fh4\u003E";
pug_mixins["data-quality-matrix"](dataset, false);
if (dataset.hasUncertainties) {
pug_html = pug_html + "\u003Chr\u002F\u003E\u003Ch4\u003E" + (pug_escape(null == (pug_interp = getLabel('uncertainties')) ? "" : pug_interp)) + "\u003C\u002Fh4\u003E";
pug_mixins["data-quality-matrix"](dataset, true);
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
});
