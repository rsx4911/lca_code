...
block: function(){
pug_html = pug_html + "\u003Ctable class=\"table no-head margin-0-25\"\u003E\u003Ctbody\u003E\u003Ctr\u003E\u003Ctd\u003E" + (pug_escape(null == (pug_interp = getLabel('address')) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd\u003E";
pug_mixins["field-block"]('address');
if (dataset.zipCode || dataset.city || (compareTo && (compareTo.zipCode || compareTo.city)) || reviewMode) {
pug_html = pug_html + "\u003Cdiv\u003E ";
pug_mixins["field"]('zipCode');
pug_html = pug_html + " ";
pug_mixins["field"]('city');
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
pug_mixins["field-block"]('country');
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";
pug_mixins["field-row"]('telephone');
pug_mixins["field-row"]('telefax');
pug_mixins["field-link-row"]('email');
pug_mixins["field-link-row"]('website');
