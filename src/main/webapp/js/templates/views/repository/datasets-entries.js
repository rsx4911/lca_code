...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, baseUrl, categoryPath, commitId, data, formatLastUpdate, getIcon, getRootLabel, isPublic, resultInfo, value, values) {
...
if (page > 1) {
pug_html = pug_html + "\u003Cspan\u003E\u003Ca" + (" class=\"page\""+pug_attr("href", getUrl(1), true, false)+" aria-label=\"First page\" data-page=\"1\"") + "\u003E\u003C\u003C\u003C\u002Fa\u003E\u003C\u002Fspan\u003E\u003Cspan\u003E\u003Ca" + (" class=\"page\""+pug_attr("href", getUrl(page-1), true, false)+" aria-label=\"Previous page\""+pug_attr("data-page", page-1, true, false)) + "\u003E\u003C\u003C\u002Fa\u003E\u003C\u002Fspan\u003E";
}
var p = startPage
while (p <= endPage) {
var isActive = (p === page)
...
if (page < pageCount) {
pug_html = pug_html + "\u003Cspan\u003E\u003Ca" + (" class=\"page\""+pug_attr("href", getUrl(page+1), true, false)+" aria-label=\"Next page\""+pug_attr("data-page", page+1, true, false)) + "\u003E\u003E\u003C\u002Fa\u003E\u003C\u002Fspan\u003E\u003Cspan\u003E\u003Ca" + (" class=\"page\""+pug_attr("href", getUrl(pageCount), true, false)+" aria-label=\"Last page\""+pug_attr("data-page", pageCount, true, false)) + "\u003E\u003E\u003E\u003C\u002Fa\u003E\u003C\u002Fspan\u003E";
}
values = [10, 25, 50, 100];
...
pug_mixins["count-span"] = pug_interp = function(entry){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (entry.count !== -1) {
pug_html = pug_html + "\u003Cspan\u003E (" + (pug_escape(null == (pug_interp = entry.count) ? "" : pug_interp)) + ")\u003C\u002Fspan\u003E";
}
};
pug_mixins["commit-link-cell"] = pug_interp = function(entry){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctd\u003E\u003Ca" + (pug_attr("href", baseUrl + '/commit/' + entry.commitId, true, false)+pug_attr("title", entry.commitMessage.length > 70 ? entry.commitMessage : null, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = entry.commitMessage.length > 70 ? entry.commitMessage.substring(0, 65) + '...' : entry.commitMessage) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Ftd\u003E";
};
if (categoryPath) {
...
pug_html = pug_html + "\u003Ctr\u003E \u003Ctd\u003E \u003C\u002Ftd\u003E\u003Ctd\u003E\u003Ca" + (pug_attr("href", previousUrl, true, false)) + "\u003E\u003Cstrong\u003E..\u003C\u002Fstrong\u003E\u003C\u002Fa\u003E\u003C\u002Ftd\u003E";
if (!isPublic) {
...
pug_html = pug_html + ("\u003Ctr\u003E\u003Ctd\u003E\u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/' + iconUrl, true, false)+pug_attr("aria-label", 'Model icon of ' + entry.type, true, false)) + "\u002F\u003E\u003C\u002Ftd\u003E\u003Ctd\u003E\u003Ca" + (pug_attr("href", baseUrl + url, true, false)) + "\u003E\u003Cstrong\u003E " + (pug_escape(null == (pug_interp = name) ? "" : pug_interp)));
if (entry.typeOfEntry !== 'DATASET') {
pug_mixins["count-span"].call({
block: function(){
pug_html = pug_html + " ";
}
}, entry);
}
pug_html = pug_html + "\u003C\u002Fstrong\u003E\u003C\u002Fa\u003E\u003C\u002Ftd\u003E";
if (!isPublic) {
pug_html = pug_html + "\u003Ctd\u003E" + (pug_escape(null == (pug_interp = formatLastUpdate(entry.commitTimestamp)) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
pug_mixins["commit-link-cell"](entry);
}
pug_html = pug_html + "\u003C\u002Ftr\u003E";
      }
  } else {
...
pug_html = pug_html + "\u003Ctr\u003E\u003Ctd" + (pug_attr("colspan", isPublic?2:4, true, false)) + "\u003E";
pug_mixins["paging"](resultInfo);
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"baseUrl" in locals_for_with?locals_for_with.baseUrl:typeof baseUrl!=="undefined"?baseUrl:undefined,"categoryPath" in locals_for_with?locals_for_with.categoryPath:typeof categoryPath!=="undefined"?categoryPath:undefined,"commitId" in locals_for_with?locals_for_with.commitId:typeof commitId!=="undefined"?commitId:undefined,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"formatLastUpdate" in locals_for_with?locals_for_with.formatLastUpdate:typeof formatLastUpdate!=="undefined"?formatLastUpdate:undefined,"getIcon" in locals_for_with?locals_for_with.getIcon:typeof getIcon!=="undefined"?getIcon:undefined,"getRootLabel" in locals_for_with?locals_for_with.getRootLabel:typeof getRootLabel!=="undefined"?getRootLabel:undefined,"isPublic" in locals_for_with?locals_for_with.isPublic:typeof isPublic!=="undefined"?isPublic:undefined,"resultInfo" in locals_for_with?locals_for_with.resultInfo:typeof resultInfo!=="undefined"?resultInfo:undefined,"value" in locals_for_with?locals_for_with.value:typeof value!=="undefined"?value:undefined,"values" in locals_for_with?locals_for_with.values:typeof values!=="undefined"?values:undefined));;return pug_html;} return template; });