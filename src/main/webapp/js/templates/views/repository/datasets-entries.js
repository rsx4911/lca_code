...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, baseUrl, categoryPath, commitId, data, formatLastUpdate, getIcon, getRootLabel, isPublic, resultInfo, type, value, values) {
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index4 = 0, $$l = $$obj.length; pug_index4 < $$l; pug_index4++) {
        var entry = $$obj[pug_index4];
var name = entry.typeOfEntry === 'MODEL_TYPE' ? getRootLabel(entry.type) : entry.name;
var iconUrl = entry.typeOfEntry === 'DATASET' || entry.typeOfEntry === 'LIBRARY' ? getIcon(entry) : 'category/' + entry.type.toLowerCase() + '.png';
var url = baseUrl;
var target = null;
...
url = '/ws/' + (entry.public ? 'public/' : '') + 'libraries/' + entry.name;
target = '_blank';
}
else {
...
pug_html = pug_html + "\u003Ctr\u003E\u003Ctd\u003E\u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/' + iconUrl, true, false)+pug_attr("aria-label", 'Model icon of ' + type, true, false)) + "\u002F\u003E\u003C\u002Ftd\u003E";
if (entry.typeOfEntry === 'LIBRARY' && !entry.available) {
pug_html = pug_html + "\u003Ctd\u003E\u003Cstrong\u003E" + (pug_escape(null == (pug_interp = name) ? "" : pug_interp)) + "\u003C\u002Fstrong\u003E\u003C\u002Ftd\u003E";
}
else {
pug_html = pug_html + ("\u003Ctd\u003E\u003Ca" + (pug_attr("href", url, true, false)+pug_attr("target", target, true, false)) + "\u003E\u003Cstrong\u003E" + (pug_escape(null == (pug_interp = name) ? "" : pug_interp)));
if (entry.typeOfEntry !== 'DATASET' && entry.typeOfEntry !== 'LIBRARY') {
