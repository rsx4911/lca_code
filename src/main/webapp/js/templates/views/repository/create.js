...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, doImport, groups, importFormat, selection) {
...
pug_html = pug_html + "\u003Cdiv class=\"header-box\"\u003EInfo\u003C\u002Fdiv\u003E\u003Cform class=\"content-box\" id=\"repository-form\"\u003E\u003Cdiv class=\"alert\" id=\"repository-form-general-message-group\" role=\"alert\"\u003E\u003Cspan class=\"message\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
pug_mixins["input"]('name', 'Name');
pug_mixins["select"]('group', 'Group', groups, selection);
if (doImport) {
if (importFormat === 'json-ld') {
pug_mixins["input"]('commitMessage', 'Initial commit message');
}
if (importFormat === 'external') {
pug_mixins["input"]('url', 'External url');
pug_mixins["input"]('username', 'Username');
pug_mixins["input"]('password', 'Password', 'password');
pug_html = pug_html + "\u003Cspan id=\"token-input\" style=\"display:none\"\u003E";
pug_mixins["input"]('token', 'Token');
pug_html = pug_html + "\u003C\u002Fspan\u003E";
}
else {
pug_mixins["input"]('data', 'Data', 'file');
}
}
pug_html = pug_html + "\u003Cbutton class=\"btn btn-lg btn-success pull-right\" data-action=\"create-repository\"\u003E" + (pug_escape(null == (pug_interp = doImport?'Import':'Create') ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"doImport" in locals_for_with?locals_for_with.doImport:typeof doImport!=="undefined"?doImport:undefined,"groups" in locals_for_with?locals_for_with.groups:typeof groups!=="undefined"?groups:undefined,"importFormat" in locals_for_with?locals_for_with.importFormat:typeof importFormat!=="undefined"?importFormat:undefined,"selection" in locals_for_with?locals_for_with.selection:typeof selection!=="undefined"?selection:undefined));;return pug_html;} return template; });