...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, isNew) {
...
pug_html = pug_html + "\u003Cdiv id=\"add-restriction\"\u003E\u003Cdiv class=\"alert\" id=\"add-restriction-general-message-group\" role=\"alert\"\u003E\u003Cspan class=\"message\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
if (isNew) {
pug_mixins["input"]('name', 'Restriction set name');
}
else {
pug_mixins["input"]('name', 'Restriction set name', 'hidden');
}
pug_mixins["textarea"].call({
attributes: {"rows": 10}
}, 'ref-ids', 'Data set reference ids (one id per line)');
pug_html = pug_html + "\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"isNew" in locals_for_with?locals_for_with.isNew:typeof isNew!=="undefined"?isNew:undefined));;return pug_html;} return template; });