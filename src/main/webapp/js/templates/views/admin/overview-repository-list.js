...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, data, isSearchEnabled, pageSizeId, resultInfo, values) {
...
pug_html = pug_html + "\u003Cdiv\u003E\u003Ca" + (" class=\"follow\""+pug_attr("href", repo.group + '/' + repo.name, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = repo.label) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
if (isSearchEnabled) {
pug_html = pug_html + "\u003Cbutton" + (" class=\"btn btn-xs btn-default pull-right\""+" data-action=\"reindex-repository\""+pug_attr("data-group", repo.group, true, false)+pug_attr("data-repository", repo.name, true, false)) + "\u003EReindex\u003C\u002Fbutton\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
      }
  } else {
...
pug_mixins["paging"](resultInfo, null, pageSizeId);}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"isSearchEnabled" in locals_for_with?locals_for_with.isSearchEnabled:typeof isSearchEnabled!=="undefined"?isSearchEnabled:undefined,"pageSizeId" in locals_for_with?locals_for_with.pageSizeId:typeof pageSizeId!=="undefined"?pageSizeId:undefined,"resultInfo" in locals_for_with?locals_for_with.resultInfo:typeof resultInfo!=="undefined"?resultInfo:undefined,"values" in locals_for_with?locals_for_with.values:typeof values!=="undefined"?values:undefined));;return pug_html;} return template; });