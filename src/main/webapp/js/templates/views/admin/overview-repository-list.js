...
pug_html = pug_html + "\u003Cdiv\u003E\u003Ca" + (" class=\"follow\""+pug_attr("href", repo.group + '/' + repo.name, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = repo.label) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003Cbutton" + (" class=\"btn btn-xs btn-default\""+" data-action=\"reindex-repository\""+pug_attr("data-group", repo.group, true, false)+pug_attr("data-repository", repo.name, true, false)) + "\u003EReindex\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
