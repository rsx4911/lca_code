...
pug_html = pug_html + "\u003Cdiv id=\"add-library\"\u003E\u003Cdiv class=\"alert\" id=\"add-library-general-message-group\" role=\"alert\"\u003E\u003Cspan class=\"message\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
if (isNew) {
pug_mixins["input"]('name', 'Library name');
}
else {
pug_mixins["input"]('name', 'Library name', 'hidden');
}
