...
pug_html = pug_html + "\u003Cdiv id=\"settings-form\"\u003E\u003Cdiv class=\"header-box\"\u003EBasic settings\u003Cbutton class=\"btn btn-primary pull-right\" data-action=\"test-search\"\u003ERun test search\u003C\u002Fbutton\u003E\u003Cbutton class=\"btn btn-primary pull-right\" data-action=\"test-glad\"\u003ECheck GLAD url\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\"\u003E\u003Cdiv class=\"two-columns\"\u003E";
pug_mixins["input"]('SERVER_SETTING__SERVER_NAME', 'Server name');
pug_mixins["input"]('SERVER_SETTING__SERVER_URL', 'Server base url (e.g. used in email links)');
...
pug_mixins["input"]('SERVER_SETTING__LIBRARY_PATH', 'Root directory for library id files');
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"three-columns\"\u003E";
pug_mixins["input"]('SERVER_SETTING__GLAD_URL', 'Glad service base url');
pug_mixins["input"]('SERVER_SETTING__GLAD_API_KEY_HEADER', 'Glad service api-key header field');
pug_mixins["input"]('SERVER_SETTING__GLAD_API_KEY', 'Glad service api-key header value');
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"four-columns\"\u003E";
pug_mixins["input"]('SEARCH_SETTING__SCHEMA', 'Elasticsearch schema');
pug_mixins["input"]('SEARCH_SETTING__HOST', 'Elasticsearch url');
pug_mixins["input"]('SEARCH_SETTING__PORT', 'Elasticsearch port');
pug_mixins["input"]('SEARCH_SETTING__INDEX_NAME', 'Elasticsearch index');
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"header-box\"\u003EEnabled features\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\"\u003E";
...
pug_mixins["checkbox"]('SERVER_SETTING__PUBLIC_REPOSITORY_ENABLED', 'Public repositories: Repositories can be marked as publicly accessible');
pug_mixins["checkbox"]('SERVER_SETTING__NOTIFICATIONS_ENABLED', 'Notifications</strong>: Users can receive notifications');
pug_mixins["checkbox"]('SERVER_SETTING__USER_REGISTRATION_ENABLED', 'User registration</strong>: Users can create accounts themselfes');
...
pug_mixins["checkbox"]('SERVER_SETTING__HOMEPAGE_ENABLED', 'Homepage</strong>: Show a landing page instead of the default search page for anonymous users');
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined));;return pug_html;} return template; });