...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index2 = 0, $$l = $$obj.length; pug_index2 < $$l; pug_index2++) {
        var team = $$obj[pug_index2];
pug_html = pug_html + "\u003Cdiv\u003E\u003Ca" + (" class=\"follow\""+pug_attr("href", 'administration/team/profile/' + team.teamname, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = team.name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
