...
var pug_match_html=/["&<>]/;function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (announcementMessage, groups, homeText, homeTitle, isAdmin, isHomepageEnabled, licenseAgreementText, maintenanceMessage, maintenanceModeActive, modelTypesOrder, openWebServiceRequests, repositories, repositoriesOrder, teams, users) {pug_mixins["box"] = pug_interp = function(label, plural, count){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var lcLabel = label.toLowerCase()	
var lcPlural = plural.toLowerCase()	
pug_html = pug_html + ("\u003Cdiv class=\"header-box\"\u003E\u003Ch4\u003E" + (pug_escape(null == (pug_interp = plural) ? "" : pug_interp)) + "\u003C\u002Fh4\u003E\u003Cdiv class=\"count\"\u003E" + (pug_escape(null == (pug_interp = count) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Chr\u002F\u003E\u003Cbutton" + (" class=\"btn btn-lg btn-full-width btn-success\""+pug_attr("data-action", 'create-' + lcLabel, true, false)) + "\u003ECreate " + (pug_escape(null == (pug_interp = lcLabel) ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"list-box\"\u003E\u003Clegend\u003E" + (pug_escape(null == (pug_interp = plural) ? "" : pug_interp)));
if (label === 'Repository') {
pug_html = pug_html + "\u003Cbutton class=\"btn btn-xs btn-default pull-right\" data-action=\"reindex-repositories\"\u003EReindex\u003C\u002Fbutton\u003E\u003Cbutton class=\"btn btn-xs btn-default pull-right\" data-action=\"clear-index\"\u003EClear index\u003C\u002Fbutton\u003E";
}
...
pug_html = pug_html + "\u003Cdiv class=\"content-box overview\"\u003E\u003Cdiv" + (pug_attr("class", pug_classes([isAdmin?'four-columns':'two-columns'], [true]), false, false)) + "\u003E";
if (isAdmin) {
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
if (isAdmin) {
...
pug_html = pug_html + "\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\"\u003E\u003Cdiv\u003E \u003Cstrong\u003ERelease version: \u003C\u002Fstrong\u003E2.5.6\u003C\u002Fdiv\u003E\u003Cdiv\u003E\u003Cstrong\u003ECommit id: \u003C\u002Fstrong\u003Eaf4afe1\u003C\u002Fdiv\u003E\u003Cdiv\u003E\u003Cstrong\u003EBuild date: \u003C\u002Fstrong\u003E12/1/2021, 13:43:27\u003C\u002Fdiv\u003E\u003Cdiv\u003E \u003Cstrong\u003EOpen web service requests: \u003C\u002Fstrong\u003E\u003Cspan id=\"open-web-service-requests\"\u003E" + (pug_escape(null == (pug_interp = openWebServiceRequests) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E \u003Ca href=\"#\" data-action=\"refresh-open-web-service-requests\"\u003E\u003Cspan class=\"glyphicon glyphicon-refresh\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"header-box\"\u003ESearch\u002FBrowse configuration\u003C\u002Fdiv\u003E\u003Cdiv class=\"content-box\"\u003E\u003Cdiv class=\"col-md-6\"\u003E\u003Cdiv class=\"model-types-order\"\u003E";
