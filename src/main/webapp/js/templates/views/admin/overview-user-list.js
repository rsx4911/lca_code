...
pug_html = pug_html + "\u003Cdiv\u003E\u003Ca" + (" class=\"follow\""+pug_attr("href", 'administration/user/profile/' + user.username, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = user.name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E \u003Cspan" + (pug_attr("class", pug_classes(["badge","pull-right",user.deactivated?'badge-danger':'badge-success'], [false,false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = user.deactivated?'Inactive':'Active') ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
