...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, data, formatDate, pageSizeId, resultInfo, values) {
...
pug_html = pug_html + "\u003Cdiv\u003E\u003Ca" + (" class=\"follow\""+pug_attr("href", 'administration/user/profile/' + user.username, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = user.name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E ";
var activeLabel = user.deactivated ? 'Inactive' : 'Active';
if (user.activeUntil) {
activeLabel += (user.deactivated ? ' since ' : ' until ') + formatDate(user.activeUntil);
}
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["badge","pull-right",user.deactivated?'badge-danger':'badge-success'], [false,false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = activeLabel) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
...
pug_mixins["paging"](resultInfo, null, pageSizeId);}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"formatDate" in locals_for_with?locals_for_with.formatDate:typeof formatDate!=="undefined"?formatDate:undefined,"pageSizeId" in locals_for_with?locals_for_with.pageSizeId:typeof pageSizeId!=="undefined"?pageSizeId:undefined,"resultInfo" in locals_for_with?locals_for_with.resultInfo:typeof resultInfo!=="undefined"?resultInfo:undefined,"values" in locals_for_with?locals_for_with.values:typeof values!=="undefined"?values:undefined));;return pug_html;} return template; });