...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, accessTypes, isAdminArea) {
...
pug_html = pug_html + "\u003Cdiv class=\"header-box\"\u003ENew library\u003C\u002Fdiv\u003E\u003Cform class=\"content-box\" id=\"library-form\"\u003E\u003Cdiv class=\"alert\" id=\"library-form-general-message-group\" role=\"alert\"\u003E\u003Cspan class=\"message\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
pug_mixins["input"]('file', 'File*', 'file');
var accessLabel = isAdminArea ? 'Access' : 'Team access';
pug_mixins["select"]('access', accessLabel, accessTypes, accessTypes[0][0]);
pug_html = pug_html + "\u003Cbutton class=\"btn btn-lg btn-success pull-right\" data-action=\"add\"\u003EAdd\u003C\u002Fbutton\u003E\u003Cdiv class=\"clear\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"accessTypes" in locals_for_with?locals_for_with.accessTypes:typeof accessTypes!=="undefined"?accessTypes:undefined,"isAdminArea" in locals_for_with?locals_for_with.isAdminArea:typeof isAdminArea!=="undefined"?isAdminArea:undefined));;return pug_html;} return template; });