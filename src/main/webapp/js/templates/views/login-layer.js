...
pug_mixins["login-form"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cform" + (pug_attrs(pug_merge([{"id": "login","method": "post"},attributes]), false)) + "\u003E\u003Ch3\u003ESign in\u003C\u002Fh3\u003E\u003Cdiv class=\"alert alert-danger\" id=\"login-general-message\" role=\"alert\"\u003E\u003Cspan class=\"message\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
pug_mixins["input"]('username', 'Username/Email');
pug_mixins["input"].call({
block: function(){
pug_html = pug_html + "\u003Ca class=\"default-link\" href=\"reset-password\"\u003EForgot your password?\u003C\u002Fa\u003E";
}
}, 'password', 'Password', 'password');
pug_mixins["input"].call({
block: function(){
pug_html = pug_html + "\u003Ca class=\"default-link\" href=\"login\"\u003ELogin with another user\u003C\u002Fa\u003E";
}
}, 'token', 'Token', 'text', false, false, true);
block && block();
pug_html = pug_html + "\u003Cdiv class=\"auth-provider-container\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E";
};
...
pug_mixins["login-form"]();}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined));;return pug_html;} return template; });