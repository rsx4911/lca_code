...
pug_html = pug_html + "\u003Cdiv class=\"result\"\u003E\u003Cimg" + (" class=\"model-icon-small\""+pug_attr("src", 'images/model/small/' + getIcon(dataset, version.flowType || version.processType), true, false)+pug_attr("aria-label", 'Model icon of ' + dataset.type, true, false)) + "\u002F\u003E\u003Cdiv class=\"result-content\"\u003E\u003Ch4\u003E";
pug_mixins["link"](dataset, repo, version.name);
...
pug_mixins["link"] = pug_interp = function(dataset, repo, title, defaultLink){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var url = repo.path + '/dataset/' + dataset.type + '/' + dataset.refId + '?commitId=' + repo.commitId;
pug_html = pug_html + "\u003Ca" + (pug_attr("class", pug_classes([defaultLink?'default-link':null], [true]), false, false)+pug_attr("href", url, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = title) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
};
pug_mixins["repositories"] = pug_interp = function(dataset, versionIndex){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var version = dataset.versions[versionIndex];
var versions = dataset.versions.length;
pug_html = pug_html + "\u003Cdiv class=\"result-repositories\"\u003Efound in " + (pug_escape(null == (pug_interp = version.repos.length === 1 ? 'repository' : 'repositories') ? "" : pug_interp)) + " \u003Cspan class=\"comma-list\"\u003E";
...
if (versions > 1) {
pug_html = pug_html + "\u003Cdiv\u003E" + (pug_escape(null == (pug_interp = versions - 1) ? "" : pug_interp)) + " other " + (pug_escape(null == (pug_interp = versions > 2 ? 'versions' : 'version') ? "" : pug_interp)) + " found in  \u003Cspan class=\"comma-list\"\u003E";
...
pug_html = pug_html + "\u003Cul class=\"dropdown-menu\"\u003E\u003Cli\u003E\u003Ca" + (" href=\"#\" data-format=\"json\" data-datatype=\"dataset\""+pug_attr("data-group", repo.group, true, false)+pug_attr("data-repo", repoName, true, false)+pug_attr("data-type", dataset.type, true, false)+pug_attr("data-ref-id", dataset.refId, true, false)+pug_attr("data-commit-id", repo.commitId, true, false)) + "\u003EDataset as JSON-LD\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca" + (" href=\"#\" data-format=\"ilcd\" data-datatype=\"dataset\""+pug_attr("data-group", repo.group, true, false)+pug_attr("data-repo", repoName, true, false)+pug_attr("data-type", dataset.type, true, false)+pug_attr("data-ref-id", dataset.refId, true, false)+pug_attr("data-commit-id", repo.commitId, true, false)) + "\u003EDataset as ILCD\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003Cli class=\"divider\" role=\"separator\"\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca" + (" href=\"#\" data-format=\"json\" data-datatype=\"repository\""+pug_attr("data-group", repo.group, true, false)+pug_attr("data-repo", repoName, true, false)+pug_attr("data-commit-id", repo.commitId, true, false)) + "\u003ERepository as JSON-LD\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca" + (" href=\"#\" data-format=\"ilcd\" data-datatype=\"repository\""+pug_attr("data-group", repo.group, true, false)+pug_attr("data-repo", repoName, true, false)+pug_attr("data-commit-id", repo.commitId, true, false)) + "\u003ERepository as ILCD\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + (pug_escape(null == (pug_interp = resultInfo.totalCount) ? "" : pug_interp)) + " results\u003Cdiv\u003E ";
if (query) {
