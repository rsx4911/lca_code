...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, roles, teams, type, users) {
...
pug_html = pug_html + "\u003Coptgroup" + (" class=\"additional-info\""+pug_attr("label", '&nbsp; &nbsp;' + description, false, false)) + "\u003E\u003C\u002Foptgroup\u003E";
      }
  } else {
    var $$l = 0;
