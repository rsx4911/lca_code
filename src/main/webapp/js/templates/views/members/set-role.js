...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Object, isRoleAvailable, roles, teams, type, users) {
...
pug_mixins["member-selection"] = pug_interp = function(multiple){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (users && users.length && teams && teams.length) {
pug_mixins["select"].call({
block: function(){
pug_mixins["optgroup"]('User', users, null, 'user');
pug_mixins["optgroup"]('Team', teams, null, 'team');
},
attributes: {"class": "member-selection","multiple": pug_escape(multiple)}
}, 'user-selection-name', 'User/Team');
}
else
if (users && users.length) {
pug_mixins["select"].call({
block: function(){
pug_mixins["options"](users, null, 'user');
},
attributes: {"class": "member-selection","multiple": pug_escape(multiple)}
}, 'user-selection-name', 'User');
}
else
if (teams && teams.length) {
pug_mixins["select"].call({
block: function(){
pug_mixins["options"](teams, null, 'team');
},
attributes: {"class": "member-selection","multiple": pug_escape(multiple)}
}, 'user-selection-name', 'Team');
}
else {
pug_mixins["select"].call({
attributes: {"class": "member-selection","multiple": pug_escape(multiple)}
...
pug_html = pug_html + "\u003Cform id=\"set-role-form\"\u003E\u003Cdiv class=\"alert\" id=\"set-role-general-message-group\" role=\"alert\"\u003E\u003Cspan class=\"message\"\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
if (users || teams) {
pug_mixins["member-selection"](true);
}
pug_mixins["select"].call({
block: function(){
// iterate roles
...
pug_html = pug_html + "\u003Coption" + (pug_attr("value", role.id, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = role.name) ? "" : pug_interp)) + "\u003C\u002Foption\u003E";
var description = type === 'group' ? role.descriptionForGroup : role.descriptionForRepository
pug_html = pug_html + "\u003Coptgroup" + (" class=\"additional-info\""+pug_attr("label", description, true, false)) + "\u003E\u003C\u002Foptgroup\u003E";
}
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fform\u003E";}.call(this,"Object" in locals_for_with?locals_for_with.Object:typeof Object!=="undefined"?Object:undefined,"isRoleAvailable" in locals_for_with?locals_for_with.isRoleAvailable:typeof isRoleAvailable!=="undefined"?isRoleAvailable:undefined,"roles" in locals_for_with?locals_for_with.roles:typeof roles!=="undefined"?roles:undefined,"teams" in locals_for_with?locals_for_with.teams:typeof teams!=="undefined"?teams:undefined,"type" in locals_for_with?locals_for_with.type:typeof type!=="undefined"?type:undefined,"users" in locals_for_with?locals_for_with.users:typeof users!=="undefined"?users:undefined));;return pug_html;} return template; });