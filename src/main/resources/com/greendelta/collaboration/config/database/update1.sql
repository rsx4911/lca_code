...
ALTER TABLE comment MODIFY restricted_to_role ENUM('NONE', 'READER', 'CONTRIBUTOR', 'REVIEWER', 'EDITOR', 'OWNER');
ALTER TABLE job MODIFY type ENUM('RESET_PASSWORD');
ALTER TABLE membership MODIFY role ENUM('NONE', 'READER', 'CONTRIBUTOR', 'REVIEWER', 'EDITOR', 'OWNER');
...
ALTER TABLE setting MODIFY type ENUM('SERVER_SETTING', 'IMPRINT_SETTING', 'MAIL_SETTING', 'SEARCH_SETTING', 'REPOSITORY_SETTING', 'GROUP_SETTING', 'LIBRARY_SETTING');
